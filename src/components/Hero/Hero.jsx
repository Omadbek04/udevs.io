...
export const Hero = () => {
  ...
  return (
    <section id="hero" className="custom_contianer ">
      <div className="mt-[140px]  flex items-center justify-between flex-col gap-12 md:gap-0 md:flex-row">
        <div className=" flex flex-col items-center md:items-stretch">
          ...
          <h1 className=" text-[24px] md:text-[40px]  mb-[20px] font-extrabold text-secondary w-full  md:w-[462px]">
            IT-Outsourcin  Company
          </h1>
